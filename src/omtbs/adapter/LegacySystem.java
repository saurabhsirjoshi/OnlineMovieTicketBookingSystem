...
public class LegacySystem {
	...
	public boolean bookSeats(String custName, String movie, String dateTime, String location){
		...
		return (makePayment(custName, amount));
	}
	...
	public void getBookingHist(String custName){
	...
	public boolean makePayment(String custName, Double amount){
		BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
		try{
